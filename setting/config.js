...
global.footer = "⇝ 𝙼𝙰𝙽𝙸 𝚇𝙼𝙳  ⇝︎" //footer section
global.status = false //"self/public" section of the bot
global.prefa = ['','!','.','#','&','/','@']
global.xprefix = '.'
global.gambar = "https://manix-md.onrender.com/assets/menu-art.jpg"
global.OWNER_NAME = "𝙼𝙰𝙽𝙸 𝚇𝙼𝙳" //
global.DEVELOPER = ["9779807044421"] //
global.BOT_NAME = "ꨄ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳 ꨄ"
global.bankowner = "ꨄ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳ꨄ"
global.creatorName = "ꨄ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳ꨄ︎"
...
global.creatorName = "ꨄ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳ꨄ"
global.footer = "ꨄ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳ꨄ" //footer section
global.link = "https://whatsapp.com/channel/0029Vb8XvFqD8SDvDPkdqG1f"
global.autobio = true//auto update bio
global.botName = "💕⃝🕊️ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳💕⃝🕊️"
global.version = "V2"
global.botname = "💕⃝🕊️ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳💕⃝🕊️"
global.author = "༒︎𝙼𝙰𝙽𝙸𝚇 𝙼𝙳 ༒︎"
global.themeemoji = '🤞'
global.wagc = 'https://whatsapp.com/channel/0029Vb8XvFqD8SDvDPkdqG1f'
global.thumbnail = 'https://manix-md.onrender.com/assets/menu-art.jpg'
global.richpp = 'https://manix-md.onrender.com/assets/bot-avatar.jpg'
global.packname = "𝐒𝐓𝐈𝐂𝐊𝐄𝐑𝐒 𖣘♔︎"
global.author = "༒︎𝙼𝙰𝙽𝙸𝚇 𝙼𝙳 ༒︎"
global.creator = "9779807044421@s.whatsapp.net"
global.ownername = 'ꨄ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳ꨄ︎'
global.onlyowner = `☠️ 𝙎𝙤𝙧𝙧𝙮, 𝙏𝙝𝙞𝙨 𝙁𝙚𝙖𝙩𝙪𝙧𝙚 𝙄𝙨 𝙍𝙚𝙨𝙩𝙧𝙞𝙘𝙩𝙚𝙙 𝙏𝙤 𝙊𝙬𝙣𝙚𝙧𝙨 𝙊𝙣𝙡𝙮.
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *𝙼𝙰𝙽𝙸𝚇 𝙼𝙳* 𝙩𝙤 𝙜𝙖𝙞𝙣 𝙤𝙬𝙣𝙚𝙧 𝙥𝙧𝙞𝙫𝙞𝙡𝙚𝙜𝙚𝙨.
🕳️ 𝙄𝙡𝙡𝙚𝙜𝙖𝙡 𝙖𝙘𝙘𝙚𝙨𝙨 𝙬𝙞𝙡𝙡 𝙗𝙚 𝙘𝙡𝙚𝙖𝙣𝙨𝙚𝙙 𝙗𝙮 𝙩𝙝𝙚 𝑻𝒂𝒍𝒉𝒂.`
  // reply
global.database = `☠️ 𝙏𝙤 𝙗𝙚 𝙖𝙙𝙙𝙚𝙙 𝙩𝙤 𝙩𝙝𝙚 𝘿𝘼𝙏𝘼𝘽𝘼𝙎𝙀 𝘽𝘼𝙎𝙀...
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *𝙼𝙰𝙽𝙸𝚇 𝙼𝙳* — 𝙊𝙧 𝙗𝙚 𝙚𝙧𝙖𝙨𝙚𝙙 𝙗𝙮 𝙙𝙚𝙛𝙖𝙪𝙡𝙩.  🔗 *No entry without approval.*`
  global.mess = {
wait: "```☠️ WAIT FOR  ☠︎︎ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳☠︎︎😈 ⚡ *Darkness intensifies...*  💀 *Brace yourself — The 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳 YT is rising.*```",
   success: "✔️ 𝗦𝗨𝗖𝗖𝗘𝗦𝗦 𝗕𝗬 👑 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳👑`  🔥 *Mission complete. The Void accepts your command.*",
   on: "`✔️👑 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳👑 𝗔𝗖𝗧𝗜𝗩𝗘 ⚔️`  🔥 *The 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳 is unleashed. Power running at full force.*  🕳️ *Enter if you dare.*",
   prem: "`⛧ PREMIUM ACCESS ONLY ⛧`  🩸 *This feature is restricted to premium users.*  📲 *Add your number to the database to unlock the dark tier.*  🕳️ *No entry without clearance. The 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳 does not negotiate.*",
   off: "`❌ 👑 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳︎︎👑 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗢𝗙𝗙 ⚰️`  🕳️ *The 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳 has gone dark. All systems offline.*  ⚡ *Recharge and prepare for the next awakening.*",
   query: {
...
private: "Sorry bro, This Feature Can Only Be Used In Private Chats",
       owner: "Sorry bro, This Feature Can Only Be Used by 👑 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳👑 brr😋",
       ...
       premium: "This feature is specifically for my owner 👑𝙼𝙰𝙽𝙸𝚇 𝙼𝙳👑 🤤🫡",
   }
}

global.onlyowner = `\`[ 🤞 ] ꨄ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳ꨄ \` \n*
...
global.database = `\`[ 👑 ] ꨄ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳ꨄ 😙 \` \n*

        🚫 𝔸ℂℂ𝔼𝕊𝕊 𝔻𝔼ℕ𝕀𝔼𝔻 🚫

❌ *𝗦𝗢𝗥𝗥𝗬, 𝗧𝗛𝗜𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 𝗜𝗦 𝗙𝗢𝗥𝗕𝗜𝗗𝗗𝗘𝗡 𝗙𝗢𝗥 𝗬𝗢𝗨!* ❌

💀 *𝗢𝗡𝗟𝗬 ꨄ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳ꨄ 𝗠𝗘𝗠𝗕𝗘𝗥𝗦 𝗜𝗡 𝗢𝗨𝗥 𝗗𝗔𝗧𝗔𝗕𝗔𝗦𝗘 𝗛𝗢𝗟𝗗 𝗧𝗛𝗘 𝗞𝗘𝗬 𝗧𝗢 𝗔𝗖𝗖𝗘𝗦𝗦.* 😈
...
𝕋𝕙𝕒𝕟𝕜𝕤 𝕗𝕠𝕣 𝕌𝕤𝕚𝕟𝕘  ꨄ 𝙼𝙰𝙽𝙸𝚇 𝙼𝙳ꨄ︎︎`
...
// MANI XMD channel and contact
global.manixChannelText = 'Follow the MANIX MD 💐 channel on WhatsApp: https://whatsapp.com/channel/0029Vb8XvFqD8SDvDPkdqG1f'
global.manixContactNumber = '9779807044421'
